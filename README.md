...
Function Code Screenshots

Table Storage Function

Code screenshot of TableStorageFunction.cs showing all functions
Blob Storage Function

Code screenshot of BlobStorageFunction.cs showing all functions
Queue Storage Function

Code screenshot of QueueStorageFunction.cs showing all functions
Azure Files Function

Code screenshot of FileStorageFunction.cs showing all functions
Web Application Screenshots (Local Testing)

Web Application with Sample Data
Screenshot of the running application at http://localhost:5184
Screenshot of Customers table with 5+ records
Screenshot of Products table with 5+ records
Screenshot of Blob Storage with 5+ uploaded images
Screenshot of Orders queue with 5+ messages
Screenshot of Inventory queue with 5+ messages
Screenshot of Azure Files with 5+ log files
